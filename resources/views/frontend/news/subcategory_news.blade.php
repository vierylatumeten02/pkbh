...
@section('title')
{{ $breadsubcat->subcategory_name }} | PKBH UNHAS
@endsection
...
<a href=" "><i class="las la-home"></i> </a> <i class="las la-chevron-right"></i> {{ $breadsubcat->category_name }}
</div>
<div class="row">
...
<a href="{{ url('news/detail/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}"><img class="lazyload" src="{{ asset($newsitem->image) }}"  ></a> </div>
<a href=" " class="archiveTab-icon2"><i class="la la-play"></i></a>
<h4 class="archiveTab_hadding"><a href="{{ url('news/detail/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}">{{$newsitem->news_title}} </a>
</h4>
...
@foreach($popularPost as $key=> $newsitem)
<div class="archive-tabWrpp archiveTab-border">
<div class="archiveTab-image ">
<a href="{{ url('news/detail/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}"><img class="lazyload" src="{{ asset($newsitem->image) }}"  ></a> </div>
<a href=" " class="archiveTab-icon2"><i class="la la-play"></i></a>
