...
<div class="contact-form">
<span class="wpcf7-form-control-wrap sub_title"><input type="file" name="photo" value="" size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" id="image" ></span>
</div>
</div>
